...
RUN echo 'deb https://mirror.steadfast.net/debian/ buster main\ndeb https://mirror.steadfast.net/debian/ buster-backports main\ndeb https://mirror.steadfast.net/debian/ buster-updates main\ndeb https://mirror.steadfast.net/debian/ buster-proposed-updates main\ndeb https://mirror.steadfast.net/debian-security/ buster/updates main' > /etc/apt/sources.list
