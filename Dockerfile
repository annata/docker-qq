...
RUN echo 'deb https://mirror.cogentco.com/debian/ buster main\ndeb https://mirror.cogentco.com/debian/ buster-backports main\ndeb https://mirror.cogentco.com/debian/ buster-updates main\ndeb https://mirror.cogentco.com/debian/ buster-proposed-updates main\ndeb https://mirror.cogentco.com/debian-security/ buster/updates main' > /etc/apt/sources.list
